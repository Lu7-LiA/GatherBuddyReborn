...
2026-09-16時点では、3地点間の最大3次元距離が小さい順に各属性の上位3 Baseを選択した。候補が2件だけのFireは、距離が小さいBase 914だけを採用した。Earthは候補なし。

- Lightning: 541, 546, 545
- Wind: 910, 906, 909
- Water: 1205, 1200, 912
- Ice: 1197, 1194, 1199
- Fire: 914

合計13 Base・39 Point。既存のBase 542はLightning候補内で9位だったため置き換えた。
